...
export function getAppRoutes(): RouteDescriptor[] {
  ...
  return [
    ...
    {
      path: '/s3-explorer',
      pageClass: 'page-s3-explorer sidemenu-hidden',
      routeName: DashboardRoutes.Normal,
    ...
    {
      path: '/eks-explorer',
      pageClass: 'page-eks-explorer sidemenu-hidden',
      routeName: DashboardRoutes.Normal,
    ...
    },
    {
      ...
      pageClass: 'page-lambda-explorer sidemenu-hidden',
      routeName: DashboardRoutes.Normal,
    ...
    {
      path: '/ec2-explorer',
      pageClass: 'page-ec2-explorer sidemenu-hidden',
      routeName: DashboardRoutes.Normal,
    ...
    {
      path: '/nlb-explorer',
      pageClass: 'page-nlb-explorer sidemenu-hidden',
      routeName: DashboardRoutes.Normal,
