      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-cloud-search-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-cloud-search-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-cloud-search-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-cloud-search-production"]} />
            ) : (
              <></>
            )}
          </div>
