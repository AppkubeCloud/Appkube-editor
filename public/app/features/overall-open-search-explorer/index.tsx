      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-open-search-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-open-search-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-open-search-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-open-search-production"]} />
            ) : (
              <></>
            )}
          </div>
