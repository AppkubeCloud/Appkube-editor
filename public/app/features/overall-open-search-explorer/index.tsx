...
class OverallOpenSearchExplorer extends Component<Record<string, string>, LocalState> {
  popupRef: any;
  constructor(props: Record<string, string>) {
    ...
    this.state = {
      ...
      value: 0,
      dashboardIDs: {
        "overall-open-search-development": "",
        "overall-open-search-test": "",
        "overall-open-search-stage": "",
        "overall-open-search-production": ""
      },
      selectedParam: "sla"
    };
    ...
    return (
      <div className="overall-explorers-container">
        <div className="heading">
          <h1><img src={images.pageTitleIcon} alt="" /> OpenSearch Service</h1>
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs[`overall-open-search-development-${selectedParam}`]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs[`overall-open-search-test-${selectedParam}`]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs[`overall-open-search-stage-${selectedParam}`]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs[`overall-open-search-production-${selectedParam}`]} />
            ) : (
              <></>
            )}
          </div>
...
export default OverallOpenSearchExplorer;
