      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-cdn-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-cdn-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-cdn-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-cdn-production"]} />
            ) : (
              <></>
            )}
          </div>
