...
const images = {
  pageTitleIcon: '/public/img/overall-explorer/cdn-title-icon.png',
}

const DASHBOARD_NAMES = ["overall-cdn-development", "overall-cdn-test", "overall-cdn-stage", "overall-cdn-production"];

const PARAMETERS_NAMES = ["sla", "performance", "reliability", "availability", "endUsage", "security", "cost"];

class OverallCdnExplorer extends Component<Record<string, string>, LocalState> {
  popupRef: any;
  constructor(props: Record<string, string>) {
    ...
    this.state = {
      ...
      value: 0,
      dashboardIDs: {
        "overall-cdn-development": "",
        "overall-cdn-test": "",
        "overall-cdn-stage": "",
        "overall-cdn-production": ""
      },
      selectedParam: "sla"
    };
    ...
    return (
      <div className="overall-explorers-container">
        <div className="heading">
          <h1><img src={images.pageTitleIcon} alt="" /> CDN</h1>
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs[`overall-cdn-development-${selectedParam}`]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs[`overall-cdn-test-${selectedParam}`]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs[`overall-cdn-stage-${selectedParam}`]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs[`overall-cdn-production-${selectedParam}`]} />
            ) : (
              <></>
            )}
          </div>
...
export default OverallCdnExplorer;
