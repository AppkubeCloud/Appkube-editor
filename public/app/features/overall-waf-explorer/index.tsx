...
class OverallWafExplorer extends Component<Record<string, string>, LocalState> {
  ...
  constructor(props: Record<string, string>) {
    ...
    this.state = {
      ...
      apiButtonsPopupOpen: false,
      showFiltersModal: false,
      value: 0,
      dashboardIDs: {
        "overall-waf-development": "",
        "overall-waf-test": "",
        "overall-waf-stage": "",
  ...
  toggleApiButtonsPopup = () => {
    this.setState({
      apiButtonsPopupOpen: !this.state.apiButtonsPopupOpen,
    });
  }
    ...
    return (
      <div className="overall-explorers-container">
        <div className="heading">
          <h1><img src={images.pageTitleIcon} alt="" /> WAF (web application firewall)</h1>
        ...
        <div className="tabs-container">
          <div className="header">
            ...
            <div className="sla-menu-popup">
              <button className="sla-btn" onClick={this.toggleApiButtonsPopup}>
                Amazon API Gateway Rest API <i className="fa-solid fa-sort-down"></i>
              </button>
              {apiButtonsPopupOpen === true && (
                <>
                  <div className={apiButtonsPopupOpen ? "sla-buttons-popup api active" : "sla-buttons-popup api"}>
                    <button className="active"><i className="fa-solid fa-circle-dot"></i> Amazon API Gateway Rest API</button>
                    <button><i className="fa-solid fa-circle-dot"></i> Application Load Balancer</button>
                    <button><i className="fa-solid fa-circle-dot"></i> AWS AppSync GraphQL API</button>
                    <button><i className="fa-solid fa-circle-dot"></i> Amazon Cognito User pool</button>
                    <button><i className="fa-solid fa-circle-dot"></i> AWS App Runner Service</button>
                    <button><i className="fa-solid fa-circle-dot"></i> Amazon CloudFront distribution</button>
                  </div>
                  <div className="sla-buttons-popup-bg" onClick={this.toggleApiButtonsPopup}></div>
                </>
              )}
            </div>
...
export default OverallWafExplorer;
