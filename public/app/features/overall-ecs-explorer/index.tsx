      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-ecs-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-ecs-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-ecs-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-ecs-production"]} />
            ) : (
              <></>
            )}
          </div>
