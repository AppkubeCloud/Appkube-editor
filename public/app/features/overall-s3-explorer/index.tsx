      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-s3-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-s3-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-s3-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-s3-production"]} />
            ) : (
              <></>
            )}
          </div>
