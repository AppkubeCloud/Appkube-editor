...
const images = {
  pageTitleIcon: '/public/img/overall-explorer/ec2-title-icon.png',
}

const DASHBOARD_NAMES = ["overall-ec2-development", "overall-ec2-test", "overall-ec2-stage", "overall-ec2-production"];

const PARAMETERS_NAMES = ["sla", "performance", "reliability", "availability", "endUsage", "security", "cost"];

class OverallEc2Explorer extends Component<Record<string, string>, LocalState> {
  popupRef: any;
  constructor(props: Record<string, string>) {
    ...
    this.state = {
      ...
      value: 0,
      dashboardIDs: {
        "overall-ec2-development": "",
        "overall-ec2-test": "",
        "overall-ec2-stage": "",
        "overall-ec2-production": ""
      },
      selectedParam: "sla"
    };
    ...
    return (
      <div className="overall-explorers-container">
        <div className="heading">
          <h1><img src={images.pageTitleIcon} alt="" /> EC2 - Elastic Compute Cloud</h1>
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs[`overall-ec2-development-${selectedParam}`]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs[`overall-ec2-test-${selectedParam}`]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs[`overall-ec2-stage-${selectedParam}`]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs[`overall-ec2-production-${selectedParam}`]} />
            ) : (
              <></>
            )}
          </div>
...
export default OverallEc2Explorer;
