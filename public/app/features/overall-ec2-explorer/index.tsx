      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-ec2-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-ec2-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-ec2-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-ec2-production"]} />
            ) : (
              <></>
            )}
          </div>
