      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-rds-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-rds-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-rds-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-rds-production"]} />
            ) : (
              <></>
            )}
          </div>
