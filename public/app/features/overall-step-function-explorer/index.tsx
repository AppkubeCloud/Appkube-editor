...
const images = {
  pageTitleIcon: '/public/img/overall-explorer/step-function-title-icon.png',
}

const DASHBOARD_NAMES = ["overall-step-function-development", "overall-step-function-test", "overall-step-function-stage", "overall-step-function-production"];

const PARAMETERS_NAMES = ["sla", "performance", "reliability", "availability", "endUsage", "security", "cost"];

class OverallStepFunctionExplorer extends Component<Record<string, string>, LocalState> {
  popupRef: any;
  constructor(props: Record<string, string>) {
    ...
    this.state = {
      ...
      value: 0,
      dashboardIDs: {
        "overall-step-function-development": "",
        "overall-step-function-test": "",
        "overall-step-function-stage": "",
        "overall-step-function-production": ""
      },
      selectedParam: "sla"
    };
    ...
    return (
      <div className="overall-explorers-container">
        <div className="heading">
          <h1><img src={images.pageTitleIcon} alt="" /> Step Function</h1>
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs[`overall-step-function-development-${selectedParam}`]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs[`overall-step-function-test-${selectedParam}`]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs[`overall-step-function-stage-${selectedParam}`]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs[`overall-step-function-production-${selectedParam}`]} />
            ) : (
              <></>
            )}
          </div>
...
export default OverallStepFunctionExplorer;
