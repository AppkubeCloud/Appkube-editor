      ...
      <div className="overall-explorers-container">
        ...
        <div className="tabs-container">
          ...
          <div className="tabs-contents">
            {value === 0 ? (
              <Development dashId={dashboardIDs["overall-step-function-development"]} />
            ) : value === 1 ? (
              <Test dashId={dashboardIDs["overall-step-function-test"]} />
            ) : value === 2 ? (
              <Stage dashId={dashboardIDs["overall-step-function-stage"]} />
            ) : value === 3 ? (
              <Production dashId={dashboardIDs["overall-step-function-production"]} />
            ) : (
              <></>
            )}
          </div>
